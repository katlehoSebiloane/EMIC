    ...
    public void start(Stage primaryStage) throws Exception {
       ...
       // lineChart.setMinWidth(1000);
        ...
        hl7.navigation.Test.setOnAction(e->{
            String test_message = "\u000BMSH|^~\\&|MINDRAY_D-SERIES^00A037009A00690C^EUI-64||||20201208145834000||ORU^R01^ORU_R01|2|P|2.6|||AL|NE||UNICODE UTF-8|||IHE_PCD_001^IHE PCD^1.3.6.1.4.1.19376.1.6.1.1.1^ISO\n" +
                    "PID|||^^^Hospital^PI||^^^^^^L\n" +
                    "PV1||I\n" +
                    "OBR|1|2^MINDRAY_D-SERIES^00A037009A00690C^EUI-64|2^MINDRAY_D-SERIES^00A037009A00690C^EUI-64|182777000^monitoring of patient^SCT|||20201208145834\n" +
                    "OBX|1|NM|150456^MDC_PULS_OXIM_SAT_O2^MDC|1.3.1.150456|98|262688^MDC_DIM_PERCENT^MDC|||||R|||20201208145834||||00A037009A00690C^^00A037009A00690C^EUI-64\n" +
                    "OBX|2|NM|149530^MDC_PULS_OXIM_PULS_RATE^MDC|1.3.1.149530|68|264864^MDC_DIM_BEAT_PER_MIN^MDC|||||R|||20201208145834\n" +
                    "\u001C";
