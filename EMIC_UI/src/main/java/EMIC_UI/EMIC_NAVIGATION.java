...
public class EMIC_NAVIGATION extends VBox {
    ...
    private Image LOGO_IMG = new Image("file:////home/katleho/Desktop/EMIC/EMIC_UI/src/main/java/EMIC_UI/Logo.png");
    ...
    EMIC_NAVIGATION(Stage PrimaryStage,String SceneName){
        ...
        Chat_Room.setOnAction(e->{
            try {
                PrimaryStage.setScene(new Scene( new EMIC_CHAT_ROOM(PrimaryStage),1920,1000));
        ...
        Activity.setOnAction(e->{
            try {
                PrimaryStage.setScene(new Scene( new EMIC_DASHBOARD(PrimaryStage),1920,1000));
            } catch (URISyntaxException uriSyntaxException) {
                uriSyntaxException.printStackTrace();
            }
        });
        ...
        E_Patient_Reports.setOnAction(e->{
            try {
                PrimaryStage.setScene(new Scene( new EMIC_FILE_LIBRARY(PrimaryStage),1920,1000));
            } catch (URISyntaxException uriSyntaxException) {
                uriSyntaxException.printStackTrace();
            }
        });
